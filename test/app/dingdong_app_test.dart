...
void main() {
  ...
  testWidgets('DingDong starts with the Dynamic workspace at version 1.4.1', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const DingDongApp());

    expect(find.text('Dynamic'), findsWidgets);
    expect(find.byKey(const Key('app-version-1.4.1')), findsOneWidget);
    expect(find.text('v1.4.1'), findsOneWidget);
