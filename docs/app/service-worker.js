const cacheName = "dingdong-app-shell-v38";
    ...
    caches
      ...
      .then((cache) =>
        cache.addAll([
          base,
          `${base}index.html`,
          `${base}styles.css?shell=38`,
          `${base}app.js?shell=38`,
          `${base}app-codecs.js?shell=38`,
          `${base}app-connection.js?shell=38`,
          `${base}app-content-transfer.js?shell=38`,
          `${base}app-formatters.js?shell=38`,
          `${base}app-installation.js?shell=38`,
          `${base}app-notifications.js?shell=38`,
          `${base}app-pairing.js?shell=38`,
          `${base}app-platform.js?shell=38`,
          `${base}app-rendering.js?shell=38`,
          `${base}app-settings.js?shell=38`,
          `${base}app-storage.js?shell=38`,
          `${base}connection-policy.js`,
          `${base}notification-policy.js?shell=38`,
          `${base}device-name.js`,
          `${base}pairing-state.js?shell=38`,
