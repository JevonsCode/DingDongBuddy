const cacheName = "dingdong-app-shell-v41";
    ...
    caches
      ...
      .then((cache) =>
        cache.addAll([
          base,
          `${base}index.html`,
          `${base}styles.css?shell=41`,
          `${base}app.js?shell=41`,
          `${base}app-codecs.js?shell=41`,
          `${base}app-connection.js?shell=41`,
          `${base}app-content-transfer.js?shell=41`,
          `${base}app-formatters.js?shell=41`,
          `${base}app-file-actions.js?shell=41`,
          `${base}app-installation.js?shell=41`,
          `${base}app-notifications.js?shell=41`,
          `${base}app-pairing.js?shell=41`,
          `${base}app-platform.js?shell=41`,
          `${base}app-rendering.js?shell=41`,
          `${base}app-settings.js?shell=41`,
          `${base}app-storage.js?shell=41`,
          `${base}connection-policy.js`,
          `${base}notification-policy.js?shell=41`,
          `${base}device-name.js`,
          `${base}pairing-state.js?shell=41`,
